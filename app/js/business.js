...
let questions = [
    {
        question: 'Would you like to: Advise on investment activities and provide strategies that the company should take?',
    ...
    {
        question: 'Would you like to: Generate sales among client accounts, including upsetting and cross-selling?',
        choice1: 'Strongly Disagree',
        choice2: 'Disagree',
        choice3: 'Neutral/Unsure',
        choice4: 'Agree',
    ...
    {
        question: 'Would you like to: Negotiate contracts and close agreements to maximize profits?',
        choice1: 'Strongly Disagree',
        choice2: 'Disagree',
        choice3: 'Neutral/Unsure',
        choice4: 'Agree',
    ...
    {
        question: 'Would you like to: Deploy successful marketing campaigns and own their implementation from ideation to execution?',
        choice1: 'Strongly Disagree',
        choice2: 'Disagree',
        choice3: 'Neutral/Unsure',
        choice4: 'Agree',
    ...
    {
        question: 'Would you like to: Analyze consumer behavior and adjust email and advertising campaigns accordingly?',
        choice1: 'Strongly Disagree',
        choice2: 'Disagree',
        choice3: 'Neutral/Unsure',
        choice4: 'Agree',
...
getNewQuestion = () => {
    if(availableQuestions.length === 0 || questionCounter > MAX_QUESTIONS) {
        ...
        return window.location.assign('/app/end1.html?score=' + score + '&max=' + MAX_QUESTIONS)
    }
